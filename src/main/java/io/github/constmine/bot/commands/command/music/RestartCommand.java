...
public class RestartCommand extends Command {
    ...
    public RestartCommand(MessageReceivedEvent event) {
        super(event);
    }

    public RestartCommand(SlashCommandInteractionEvent event) {
        super(event);
    }
    ...
    public void executeCommand() {
        ...
        PlayerManager.getINSTANCE().musicRestart(event.getGuildChannel().asTextChannel());
